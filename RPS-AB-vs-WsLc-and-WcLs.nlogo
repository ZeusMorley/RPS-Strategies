...
It pairs up the [Article](https://medium.com/ground-state-curiosity/how-to-probably-win-at-rock-paper-scissors-172aa3e768a8)-based strategy  with the following:
1) **Win-Stay/Lose-Change**
2) **Win-Change/Lose-Stay**

## HOW IT WORKS


- The agent colored in **White** uses the **_Article-Recommended strategy_** and its next hand thrown is based on what hand the agent colored in _Yellow_ throws

- The agent colored in **Violet** also uses the **_Article-Recommended strategy_** and its next hand thrown is based on what hand the agent colored in _Pink_ throws

- The agent colored in **Yellow**uses the **_Win-stay/Lose-change strategy_** and its next hand thrown is based on what hand the agent colored in _White_ throws

- The agent colored in **Pink** uses the **_Win-change/Lose-stay strategy_** and its next hand thrown is based on what hand the agent colored in _Violet_ throws
@#$#@#$#@
default
true
0
